  ...
  return(
    ...
    <nav className={`fixed top-0 left-0 w-full flex item-center justify-between px-6 py-4 z-50 transition-transform duration-300 ${visible?"translate-y-0":"-translate-y-full"}`}>
      ...
      <div className="hidden lg:block">
        <a href="#contact" className="bg-gradient-to-r from-pink-500 to-blue-500 text-white px-5 py-2 rounded-full font-medium shadow-lg hover:opaity-90 transitiom-opacity duration-300">
          Reach Out
        </a>
